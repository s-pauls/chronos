...
namespace Chronos.App.Controllers
{
    ...
    [ApiController]
    public class RequestsOfWorController : ControllerBase
    {
        private readonly IMapper _mapper;
        private readonly IMediator _mediator;
        private readonly IRequestOfWorkService _requestOfWorkService;

        public RequestsOfWorController(
            IMapper mapper,
            IMediator mediator,
        ...
        [HttpGet("statuses")]
        public async Task<ApiListResponse<ApiContract.RequestOfWorkStatusItem>> GetDefaultItem()
        {
